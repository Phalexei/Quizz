...
public class ClientController extends MessageHandler implements Controller {
    ...
    public void handleMessage(SocketHandler socketHandler, Message message) {
        switch (message.getCommand()) {
            // all valid messages
            case PING:
                connectionManager.send(new PongMessage(playerId, message));
                break;
            case PONG:
    ...
    private void waitForOpponent(WaitMessage message) {
        //TODO: autogenerated stub
    }

    private void questionTimeout(NoAnswerMessage message) {
        //TODO: autogenerated stub
    }

    private void showQuestion(QuestionMessage message) {
        //TODO: autogenerated stub
    }

    private void showAvailableThemes(ThemesMessage message) {
        //TODO: autogenerated stub
    }

    private void updateAvailableGames(GameMessage message) {
        //TODO: autogenerated stub
    }

    private void gameEnded(int userScore, int opponentScore) {
        //TODO: autogenerated stub
    }
